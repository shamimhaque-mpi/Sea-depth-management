		...
		<div class="col-12">
			<div class="card" style="min-height: 79vh;">
				<div class="custom-table-head">
					<h5>Time Statistical Visualization</h5>
...
export default {
	...
	methods:{
		...
		generateGrap:function(){
			setTimeout(()=>{ChartService.statisticalVisualization(this.depth_list, this.attribute,  this.grid, true), 100});
		},
		...
		replaceKeyByattr:function(data){
			...
			Object.values(data.data).forEach(item=>{
				packet.push({[attr]:item.mean_value});
			});
			return packet;
		}
	},
